...
func (r *resolver) GetSelector(context.Context) map[string]string {
	return map[string]string{
		common.LabelKeyResolverType: "clusterscoped",
	}
}
...
func (r *resolver) Resolve(ctx context.Context, params map[string]string) (framework.ResolvedResource, error) {
	...
	case "task":
		...
		// TODO: Strip unwanted fields like the k8s
		...
		task.TypeMeta.APIVersion = "tekton.dev/v1beta1"
	...
	case "pipeline":
		...
		pipeline.TypeMeta.APIVersion = "tekton.dev/v1beta1"
